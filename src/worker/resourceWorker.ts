...
import { redisConnection, type ResourceJobData } from "../lib/queue.js";
...
const downloadPdfFromGCS = async (refId: string): Promise<Buffer> => {
...
const processResource = async (job: Job<ResourceJobData>): Promise<void> => {
